...
class Trainer(BaseModel):
    ...
    isActive: bool = Field(..., title="Trainer Status", example=True)
    isDeleted: bool = Field(..., title="Trainer Deletion Status", example=True)
    batches: Optional[Set[str]] = Field(
        ..., title="Batches", example={"Mor-1245", "Eve-1245"}
    )
    about: Optional[str] = Field(
        ..., title="Trainer Information", example="Description about Student"
    )
...
class TrainerReturn(BaseModel):
    u_id: int = Field(..., title="Student Id", example="S-052")
    instituteId: int = Field(..., title="Institute Id", example="12345")
    firstName: str = Field(..., title="First Name", example="Adam")
    middleName: str = Field(..., title="Middle Name", example="Stewart")
    lastName: str = Field(..., title="Last Name", example="Kallis")
    ...
    about: str = Field(
        ..., title="Trainer Information", example="Description about Trainer"
    )
...
class TrainerUpdate(BaseModel):
    ...
    instituteId: Optional[int] = Field(None, title="Institute Id", example="12345")
    ...
    isActive: Optional[bool] = Field(None, title="Trainer Status", example=True)
    isDeleted: Optional[bool] = Field(
        None, title="Trainer Deletion Status", example=True
    )
    batches: Optional[Set[str]] = Field(
        None, title="Batches", example={"Mor-1245", "Eve-1245"}
    )
    about: Optional[str] = Field(
        None, title="Trainer Information", example="Description about Trainer"
    )
...
class TrainerDelete(BaseModel):
    status_delete: bool = Field(..., title="Trainer Status", example=True)
